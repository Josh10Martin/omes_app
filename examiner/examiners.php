...
?>
	...
	<body>
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content">
					...
					<div class="row justify-content-between">
						...
						<div class="col-md-3">
							<button class="btn btn-sm btn-outline-primary float-right" data-toggle="modal" data-target="#upload_to_belts">
								<i class="fa fa-cloud-upload" aria-hidden="true"></i> Upload To Belts
							</button>
						</div>
					...
					<div id="upload_to_belts" class="modal fade delete-modal" role="dialog">
			...
			<!-- Upload to belts -->
			<!-- <div id="upload_to_belts" class="modal fade" role="dialog">
