...
if($_SESSION["user_type"]  == "ADMIN"){
    ...
    if(isset($_GET["id"])){
        ...
        $sql = $db_9->prepare("SELECT DISTINCT nrc AS nrc,id AS id,tpin,first_name AS first_name,last_name AS last_name,phone_number AS phone,address AS address,
  ...
  <div class="blue-ecz">PERSONAL DETAILS:</div> 
        <div class="row">
            <div class="col-md-6 ">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p>NRC Number:<input required disabled type="text" placeholder="Nrc..." class="form-control" name="nrc_number" value="<?php echo $nrc; ?>" maxlength="11"></p>
                    </div>
                    <div class="col-md-6">
                        <p>Phone Number:<input required type="text" maxlength="10" placeholder="phone number..." class="form-control" name="phone_number" value="<?php  echo $phone;?>"></p>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6 ">
                    ...
                    <div class="col-md-6">
                        <p>Title:
                            <select class="select" name="title" required>
                                ...
                                <option value="MISS" <?php echo $examiner_title == "MISS" ? "selected": ""; ?>>MSS</option>
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <p>Belt Number:<input required type="text" placeholder="belt number..." class="form-control" name="belt_no" value="<?php echo $belt_no; ?>"></p>
                    </div>
                    <div class="col-md-6">
                        <p>Attendance:
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>Marking Center:<input required type="text"  placeholder="Marking center..." class="form-control" name="marking_centre_name" value="<?php echo $_SESSION['marking_centre']; ?>" disabled></p>
        ...
        <div class="col-md-6">
                <div class="blue-ecz">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <p>T-PIN:<input type="text" required placeholder="10 digit t-pin" class="form-control" name="tpin" value="<?php echo $tpin; ?>" maxlength="10"></p>
                    </div>
