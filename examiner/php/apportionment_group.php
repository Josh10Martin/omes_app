...
if(isset($_POST['belt_no'])){
        ...
        $id = $_POST['id'];
        $belt = belt_added_g12_gce($db_12_gce,$belt_no,$subject_code,$paper_no,$_SESSION['marking_centre_code']);
        ...
        // $centre_in_belt = centre_in_belt($db_12_gce,$school,$subject_code,$paper_no,$_SESSION['marking_centre_code'],$_SESSION['province_code']);
        ...
        if(!$belt_no){
                ...
                try{
                $sql = $db_12_gce->prepare('INSERT IGNORE INTO group_apportion(id,subject,paper,belt_no,marking_centre,username,date_created)
