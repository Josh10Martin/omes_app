...
if(isset($_POST['subject']) && isset($_POST['paper'])){
        ...
        WITH highest_claim AS(
                ...
                GROUP BY ga.no_of_scripts,ga.belt_no
                        ...
                        ex.bank AS bank,ex.branch AS branch,:subject_code AS subject_code,:subject_name AS subject_name,:paper_no AS paper_no,ex.belt_no AS belt_no,:session_year AS session,CONCAT(:session_year," ",:session_name) AS session_name
                       ...
                       UNION
                        ...
                        ex.bank AS bank, ex.branch AS branch, :subject_code AS subject_code, :subject_name AS subject_name, :paper_no AS paper_no,ex.belt_no AS belt_number,:session_year AS session, CONCAT(:session_year," ",:session_name) AS session_name
