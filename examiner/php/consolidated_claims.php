...
$sql = $db_12_gce->prepare('SELECT marking_centre_name,examiner_number,nrc,tpin,full_name,address,province,district,position,no_of_scripts,bank,branch,sortcode,account_no,gross_pay,15_wht,net_pay,subject_code,subject_name,paper_no,belt_no,:session_name AS session
                                FROM examiner_claim WHERE marking_centre_code =:marking_centre_code

                                UNION
                                SELECT marking_centre_name,examiner_number,nrc,tpin,full_name,address,province,district,position,no_of_scripts,bank,branch,sortcode,account_no,gross_pay,15_wht,net_pay,subject_code,subject_name,paper_no,belt_no, :session_name AS session
