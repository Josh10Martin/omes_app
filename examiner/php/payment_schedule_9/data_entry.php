...
include '../../../config.php';
$data_array = array();
$sql = $db_9->prepare('SELECT marking_centre_name,examiner_number,nrc,tpin,full_name,position,no_of_scripts,bank,branch,sortcode,account_no,gross_pay,15_wht,net_pay
