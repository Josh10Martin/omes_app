...
$data_array = array();
 if(isset($_POST['subject_code']) && isset($_POST['paper']) && isset($_POST['belt_no'])){
        ...
        $sql = $db_12_gce->prepare('SELECT DISTINCT e.examiner_number AS examiner_number,e.nrc AS nrc,e.id AS id,e.first_name AS first_name,e.last_name AS last_name,e.belt_no AS belt_no,
        e.email AS email
