...
$sql = $db_12_gce->prepare('SELECT mr.id AS id, s.subject_name AS subject_name,pa.paper_no AS paper_no,mr.chief_examiner AS chief_examiner,mr.deputy_c_examiner AS deputy_c_examiner,mr.t_leader AS t_leader, mr.examiner AS examiner,mr.data_entry AS data_entry
