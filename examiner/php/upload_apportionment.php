...
if (isset($_FILES['myFile']['name']) && isset($_POST['group_id']) && isset($_POST['subject_code']) && isset($_POST['paper_no']) && isset($_POST['belt_no'])) {
    ...
    try {
        if (($handle = fopen($file_path, 'r')) !== false) {
            ...
            $sql = $db_12_gce->prepare('INSERT IGNORE INTO apportionment (school, script_no, group_id, subject, paper, belt_no, marking_centre, username, date_apportioned) VALUES (:centre_code, :script_no, :group_id, :subject_code, :paper_no, :belt_no, :marking_centre_code,  :username, NOW())');
