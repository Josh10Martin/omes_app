...
if(isset($_POST['search'])){
        ...
        $sql = $db_12_gce->prepare('SELECT m.id AS id, m.centre_code AS centre_code,m.exam_no AS exam_no,m.first_name AS first_name,m.last_name AS last_name,m.belt_no AS belt_no,
