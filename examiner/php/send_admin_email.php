...
if(isset($_POST['email']) && isset($_POST['username']) && isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['password']) && isset($_POST['marking_centre_name'])){
...
//     $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    $mail->Subject = 'Chosen as admin for Grade 9 marking';
    $mail->Body    = 'Dear '.$first_name.' '.$last_name.'<br /><br /> You have been chosen by the Senior Education Standards Officer (SESO) to be Administrator for Grade 9 exams at '.$marking_centre_name.' in your province.
    ...
    $mail->AltBody = 'Dear '.$first_name.' '.$last_name.'<br /><br /> You have been chosen by the Senior Education Standards Officer (SESO) to be Administrator for Grade 9 exams at '.$marking_centre_name.' in your province.
    Visit or copy the link below and enter the username <span style="font-weight:bold;">'.$username.'</span> and password <span style="font-weight:bold;">'.$password.'</span>. <br /><br />
    '.$link.' <br /></br />
    Regards<br /> Examinations Council of Zambia';
