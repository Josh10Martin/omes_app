...
if(isset($_POST['subject']) && isset($_POST['paper'])){
        ...
        $sql = $db_12_gce->prepare(' WITH highest_claim AS(
        ...
        ex.account_no AS account_no, ex.role AS position, CASE WHEN ex.role = "CHIEF EXAMINER" THEN mr.chief_examiner * :rate_value ELSE mr.deputy_c_examiner * :rate_value END AS paper_rate, 
        (
       ...
       ex.bank AS bank,ex.branch AS branch,mr.chief_examiner * :rate_value AS chief_examiner_rate,mr.deputy_c_examiner * :rate_value AS deputy_chief_examiner_rate
			...
			<div class="items p-3 ">
				<div class="row justify-content-center">
					<div class="col-md-9 alert alert-info">
						<h3 class="text-center"> CHIEF / DEPUTY CHIEF EXAMINER, <?php echo $subject_code,' - ',subject_name($db_12_gce,$subject_code); ?> PAPER <?php echo $paper_no; ?> </h3> 
					</div>
