...
$pdf = new Dompdf($options);
    ...
    if(isset($_POST['centre_improvised']) && isset($_POST['subject']) && isset($_POST['paper'])){
        ...
        $sql = $db_12_gce->prepare('SELECT m.exam_no AS exam_no,m.first_name AS first_name,m.last_name AS last_name,m.mark AS mark,m.entered_by AS entered_by,
                                ...
                                Group BY m.exam_no,m.first_name,m.last_name,m.mark,m.entered_by,sc.centre_code,sc.centre_name,su.subject_code,su.subject_name,pa.paper_no
                                ');
        $sql->execute(array(
