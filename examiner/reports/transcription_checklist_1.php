...
$pdf = new Dompdf($options);
    ob_start();
    if((isset($_POST['centre_code']) || (isset($_SESSION['centre_code'])) && (isset($_POST['subject']) || isset($_POST['subject_code'])) && isset($_POST['paper']) || isset($_SESSION['paper_no']))){
        ...
        if($_SESSION['province_code'] == 11){
            $sql = $db_9->prepare('SELECT m.exam_no AS exam_no,m.first_name AS first_name,m.last_name AS last_name,m.mark AS mark,
            m.status AS status, m.entered_by AS entered_by,sc.centre_code AS centre_code,sc.centre_name AS centre_name,
...
<html>
    ...
    <table class=" w100" style=" margin-top:10px;margin-top:25px;">
