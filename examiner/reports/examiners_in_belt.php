...
$pdf = new Dompdf($options);
    ...
    if(isset($_POST['subject']) && isset($_POST['paper']) && isset($_POST['belt_no'])){
        ...
        $i =0;
        $sql = $db_12_gce->prepare('SELECT ex.nrc AS nrc, CONCAT(ex.first_name," ",ex.last_name) AS full_name,su.subject_code AS subject_code, su.subject_name AS subject_name,ex.role AS role,pa.paper_no,
