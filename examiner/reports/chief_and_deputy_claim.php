...
$pdf = new Dompdf($options);
    ...
    if(isset($_POST['subject']) && isset($_POST['paper'])){
        ...
        ex.account_no AS account_no, ex.role AS position, CASE WHEN ex.role = "CHIEF EXAMINER" THEN mr.chief_examiner ELSE mr.deputy_c_examiner END AS paper_rate, 
        (
       ...
       ex.bank AS bank,ex.branch AS branch,mr.chief_examiner AS chief_examiner_rate,mr.deputy_c_examiner AS deputy_chief_examiner_rate
...
$pdf->stream('chief_examiner_deputy_chief_examiner_claim', Array('Attachment'=>0));
