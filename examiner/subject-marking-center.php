...
<div class="page-wrapper">
    <div class="content">
        <div class="row justify-content-between px-2">
            <div class="col-xs-6">
                <h4 class="page-title">SUBJECT MARKING CENTERS</h4>
            </div>
            <div class="col-xs-6">
                <a href="javascript:void(0)" class="btn btn-default btn-sm"><i class="fa fa-bars"></i> MARKING CENTERS LIST</a>
            </div>
...
<div class="modal fade" id="edit-subject-center" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header p-2 bg-success ">
            <div class="modal-title text-white h5 text-center">EDIT SUBJECT MARKING CENTER</div>
