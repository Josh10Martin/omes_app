                ...
                <div class="items p-3 ">
                    ...
                    <form action="" method="post" id="parameters-form" class="form-by-centre">
                      ...
                      <div class="row justify-content-center p-2">
                          ...
                          <div class="col-md-4 col-sm-6">
                              <label class="font-weight-bold" for="">Paper:</label>
              ...
              <div class="load"></div>
                  ...
                  <div class="row justify-content-center align-items-center p-2">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <select name="app_belt_no" class="select" id="" required>
                        </select>
                    </div>
                    <!-- <div class="col-md-4 col-sm-6">
                        <label class="font-weight-bold" for="">End Centre:</label>
          ...
          <div class="load"></div>
            ...
            <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Missing Marks</h4>
                    </div>
                </div>
<div class="row justify-content-between p-2">
    ...
    <div class="col-md-4">
        <div class="d-flex justify-content-between align-items-center ">
            ...
            <div class="col-xs-4 px-1 align-items-center ">
              <a href="#" id="pdf-btn"> PDF <i class="fa fa-file-pdf-o red-ecz" aria-hidden="true"></i></a> 
            </div>
            <!-- <div class="col-xs-4 px-1 align-items-center">
              <a href="#" id="csv-btn"> CSV <i class="fa fa-file-excel-o green-ecz" aria-hidden="true"></i></a>
            </div> -->
        </div>
    </div>
				...
				<div class="modal-content">
					...
					<form action="" method="post">
						<div class="modal-body ">
							...
							<div class="row">
								<div class="col-md-4">
									<label for="">Marking Center</label>
...
<script>
  ...
  function convertToCSV(data) {
    ...
    const csvContent = [
        keys.join(separator),
        ...data.map(item => keys.map(key => item[key]).join(separator))
    ].join('\n');
...
$(document).ready(function () {
    $("#csv-btn").click(function () {
        $.ajax({
            url: 'php/get_files.php', // Replace with your data source URL
            method: 'POST',
            dataType: 'json',
            success: function (data) {
