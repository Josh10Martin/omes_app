                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
								...
								<li><a href="marks_entry_by_examnumber.php"> By Exam Number</a></li>
							</ul>
                        </li>
                         <li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
								...
								<li><a href="sessos.php"> SESO</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
								...
								<li><a href="subject-marking-center.php"> Subject Marking Center</a></li>
								<li><a href="javascript:void(0)"> Other</a></li>
							</ul>
                        </li>
                        <!-- <li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a href="reports/centers_in_belt.php"> Centers in belt </a></li>
								<!-- <li><a href="reports/invoice-reports.html"> Invoice Report </a></li> -->
							</ul>
						</li>
                        ...
                        <li>Pages</li>
                        <li>
                            <a href="login.php"><i class="fa fbes"></i> <span>Login</span></a>
                        </li>
