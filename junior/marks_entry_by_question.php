			...
			success: function(data){
				...
				if(data.status == '400'){
					...
					$.each(data.candidate,function(){
						...
						'<td>'+
                            '<input type="text" class="form-control mark" name="raw_mark['+this["exam_no"]+']" value="'+this["mark"]+'" maxlength="3" pattern="[0-9]+" max="'+this["max_mark"]+'" style="width:40px;" required/>'+
