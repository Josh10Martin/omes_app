...
?>
          ...
          <div class="items p-3 ">
            ...
            <div class="row justify-content-center">
              <div class="col-md-5 d-flex justify-content-center p-3">
                <span class="px-2">
                  <input type="radio" name="radio" checked id="by-centre">
                </span> By Centre
                <span class="px-2">
                  <input type="radio" name="radio" id="by-belt">
                </span>By Belt
            ...
            <form action="" method="post" id="parameters-form" class="form-by-centre">
            ...
            <form action="reports/missing_marks.php" target="_blank" method="post" class="form-by-belt d-none">
              ...
              <div class="row justify-content-center align-items-center p-2">
                ...
                <div class="col-md-4 col-sm-6">
                  <label class="font-weight-bold" for="">BELT:</label>
                  <select name="belt_number" class="select" id="" required>
                  </select>
                </div>
                <!-- <div class="col-md-4 col-sm-6">
                      <label class="font-weight-bold" for="">End Centre:</label>
  ...
  <script>
    $(document).ready(function() {
      ...
      get_paper();
      missing_mark_list();
      $('.form-by-belt').addClass('d-none')

      $('input[type=radio]').change(function() {
        var radio_id = $(this).attr('id')
        if (radio_id == 'by-centre') {
          $('.form-by-belt').addClass('d-none')
          $('.form-by-centre').removeClass('d-none')
        } else {
          $('.form-by-centre').addClass('d-none')
          $('.form-by-belt').removeClass('d-none')
        }
  ...
  <script>
    $("#pdf-btn").click(function() {
      ...
      const full_session = session_year + ' - ' + session_name;
      const report_title = "MISSING MARKS REPORT";
      const report_header = "EXAMINATIONS COUNCIL OF ZAMBIA";
      var doc = new jsPDF()
      ...
      doc.autoTable({
        ...
        didDrawPage: function(data) {
          ...
          doc.setFontSize(13);
          var headerWidth = doc.getTextWidth(report_header);
          var headerX = (pagewidth - headerWidth) / 2;
          // doc.text('EXAMINATIONS COUNCIL OF ZAMBIA', 70, 38);
          doc.text(report_header, headerX, 38);
          doc.setFontSize(11);
          // dynamically center the full session name
          var textWidth = doc.getTextWidth(full_session);
          var reportTitleWidth = doc.getTextWidth(report_title);



          var sessionX = (pagewidth - textWidth) / 2;
          doc.text(full_session, sessionX, 44);

          var reportTitleX = (pagewidth - reportTitleWidth) / 2;
          doc.text(report_title, reportTitleX, 50);



          //doc.addImage(img, 'PNG', logoX, logoY, logoWidth, logoHeight);
          doc.addImage(headerImg, 'JPEG', 95, 10, 20, 20);
