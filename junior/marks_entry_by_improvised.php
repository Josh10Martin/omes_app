    ...
    function update_improvised_mark(){
        $('button.update').click(function(){
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {exam_no:exam_number,subject_name:subject_name,paper_no:paper_number,mark:mark},
                dataType: 'json',
                success:function(data){
                    if(data.status == '200'){
    ...
    function delete_candidate(){
        var exam_number = $('input[type=hidden][name=exam_number]').val(),
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {exam_no:exam_number,subject_name:subject_name,paper_no:paper_number},
                dataType: 'json',
                success:function(data){
                    if(data.status == '200'){
                        cancel();
