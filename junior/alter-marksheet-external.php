        ...
        <div class="border border-primary">
            ...
            <div class="row p-2 bg-white">
                ...
                <div class=" col-md-4 bg-light">
                            ...
                            <button type ="submit" class="btn btn-primary d-block mx-auto">Alter</button>
                            <div class="load"></div>
                        </div>
                        </div>
        ...
        dadaType: 'json',
         success:function(data){
            ...
            $('select[name=marking_centre]').append(
                    '<option value="" selected required>Select marking centre to transfer..</option>'
                );
            $.each(data,function(){
                $('select[name=marking_centre]').append(
...
function alter(){
    $('#alter_marksheet').submit(function(e){
        e.preventDefault();
        $('.dialog2').text('Are you sure you want to alter marksheet? Any entered marks on the affected examination centres will be nullified. Continue?').dialog('open');
...
function send_deo_email(first_name,last_name,centre_code,centre_name,email){
    $.ajax({
