    ...
    <div class="main-wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="content p-3">
          ...
          <div class="id"></div>
          <form action="" method="" class="my-auto mx-auto p-4 " style="background-color:#edf2f3; border-radius:5px;" id="add_transcriber">
            <div class="text-center h4">New Transcriber</div>
          ...
          <input type="hidden" name="role" value="TRANSCRIBER">
