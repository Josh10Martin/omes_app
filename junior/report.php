...
<head>
    ...
    <style type="text/css" media="all">
        ...
        .clearfix::after {
          ...
          @page{margin-top:10px; margin-bottom: 5cm;}
          header{
            position:fixed;
            top: 0;
            left: 0;
...
<header>
    <div class="header">
        <div class="clearfix">
            <div class="logo-img">
                <!-- <img class="center" src="http://localhost/marks/marksentry/assets/img/pnglogo.png" alt=""> -->
                <img class="center" src="../assets/img/pnglogo.png" alt="">
            </div>
            <div class="items-center">
                <h2>Examinations Council Of Zambia</h2>
                <h3 >Examiners per belt</h3>
                <h3 >Reports</h3> 
            </div>
        </div>
    </div> 
...
<main>
    <div class="main">
        <!-- <h1 >Examiners report external page</h1> -->
        <table >
                <thead>
                    <tr>
                        <th>Name</th>
