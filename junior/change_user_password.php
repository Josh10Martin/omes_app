...
<?php
if ($_SESSION['user_type']  == 'ADMIN' || $_SESSION['user_type']  == 'SESO' || $_SESSION['user_type']  == 'DEO' || $_SESSION['user_type']  == 'ECZ') {
?>
    ...
    <body>
        ...
        <div class="account-page">
          <div class="header-login">
            ...
            <div class="row justify-content-center">
              <div class="col-auto"><h3 class="lead text-center text-primary">Password Change</h3></div> 
            </div>
  ...
  $('.dialog1').dialog({
      ...
      $.ajax({
        url: 'php/change_user_password.php',
        method: 'POST',
        data: $(this).serialize(),
        dataType: 'json',
        beforeSend: function(){
