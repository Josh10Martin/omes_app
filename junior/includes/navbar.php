...
if(!isset($_SESSION['user_type']) && !isset($_SESSION['first_name']) && !isset($_SESSION['last_name'])){
   ...
   $session_type = '[UNKNOWN]';
    ...
    $session_type = $_SESSION['session_type'] == 'I' ? 'GRADE 9 INTERNAL' : 'GRADE 9 EXTERNAL';
...
<div class="header">
            ...
            <h6 style="color:white; text-transform:uppercase; text-align:center; position:absolute;top:70%;left:50%; transform:translate(-50%,-50%);"> <?php echo $_SESSION['user_type'] == 'ECZ' ? '' : ($_SESSION['user_type'] == 'SESO' ? 'marking centre: Marking Centre not applicable': 'marking centre: '.$_SESSION['marking_centre']); ?></h6>
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
                        ...
                        ?>
                            <a class="dropdown-item" href="edit_details.php">Update My Details</a>
