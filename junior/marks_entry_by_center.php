        ...
        window.onbeforeunload = function ()
{
	...
	function press_enter(){
        ...
        $('body').on('keydown', 'input', function(e) {
            ...
            //     $(this).closest('tr').find('td:nth-child(6)').children().val('X');
            // }
            var mark = $(this).val(),
      ...
      $(":checkbox").on("change", function() {
        ...
        if (chx){
            ...
            targetRow.find('td:nth-child(5)').children().val('');
            targetRow.find('td:nth-child(6)').children().val('L');
            targetRow.find('td:nth-child(7)').children().val('none');
            targetRow.find('td:nth-child(8)').children().val('none');
				...
				if(data.status == '400'){
					...
					$.each(data.candidate,function(){
                        var checked = this["status"] == 'X' ? 'checked' : '',
                         disabled = this["status"] == 'X' ? 'disabled' : '';
						...
						'<td>'+
                            '<input type="text" class="form-control mark" name="raw_mark['+this["exam_no"]+']" value="'+this["mark"]+'" maxlength="3" pattern="[0-9]+" max="'+this["max_mark"]+'" style="width:40px;text-align:center;" placeholder="0" '+disabled+'/>'+
