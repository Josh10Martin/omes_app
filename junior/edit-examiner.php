...
if($_SESSION["user_type"]  == "ADMIN" || $_SESSION['user_type'] == 'DEO'){
    ...
    if(isset($_GET["nrc"]) || isset($_SESSION["nrc"])){
        ...
        <div class="row">
            <div class="col-md-6 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p>Email:<input type="email" placeholder="email..." class="form-control" name="email" value="<?php  echo $email; ?>"oninput="this.value = this.valutoLowerCase()"></p>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <p>Belt Number: 
                        <select name="belt_no" class="select" id="belt" reqired>
        ...
        buttons: [
            ...
            // },
            {
                ...
                click: function(){
                    ...
                    <?php if(isset($_SESSION['nrc'])){ ?>
                    location.href="add-examiners.php";
