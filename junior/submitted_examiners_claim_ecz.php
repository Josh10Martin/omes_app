...
<div class="page-wrapper">
    <div class="content">
        <div class="row justify-content-between px-2">
            <div class="col-sm-6">
                <h4 class="page-title">SUBMITTED CLAIMS (GRADE 9 EXAMINERS)</h4>
            </div>
            
            <!-- <div class="col-xs-6">
                <a href="javascript:void(0)" data-toggle="modal" data-target="#add-marking-center" class="btn bg-light btn-sm"> Generate Claims</a>
            </div> -->
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                <h1><a href="javascript:void(0)" data-toggle="modal" data-target="#examiners_claim_modal" class="btn bg-light "> Generate Examiner Claims</a></h1>
                <h1><a href="javascript:void(0)" data-toggle="modal" data-target="#transcriber_claim_modal" class="btn bg-light "> Generate Transcriber Claims</a></h1>
            </div>
            <br>
        </div>
...
<!-- end -->
        ...
        <!-- Transcriber Claim Modal -->
<div class="modal fade" id="transcriber_claim_modal" tabindex="-1" role="dialog" aria-labelledby="claimModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <form action="reports/Transcribers_claim_report.php" target="_blank" method="post" style="width:100%;">
      <div class="modal-content">
        <div class="modal-header bg-success p-1 d-flex justify-content-center">
          <h5 class="modal-title h4 text-white text-center" id="claimModalLabel">Transcriber Payment Claim</h5>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
            ...
            <input type="hidden" name="examiner_type" value="transcriber">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.status == '400'){
                        ...
                        '<td colspan="10">There are no submitted claims to display</td>'+
                        '</tr>');
                    }else{
                        $.each(data,function(){
  ...
  $('#examiners_claim_modal').on('shown.bs.modal', function () {
      $('#marking_centre,#subject,#belt,#paper').select2({
        dropdownParent: $('#examiners_claim_modal') 
    });
});


}
// $('#transcriber_claim_modal').on('shown.bs.modal', function () {
//       $('#marking_centre').select2({
//         dropdownParent: $('#transcriber_claim_modal') // Ensures dropdown is appended to the modal
//     });
// });
