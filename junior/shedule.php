    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="page-title"><?php if($examiner == 'examiner'){echo 'EXAMINER';} else if($examiner == 'deo'){echo 'DATA ENTRY';}else{echo 'SYSTEM ADMIN';} ?> PAYMENT SCHEDULE </h4> 
                    </div>
                </div>
                <div class="d-flex">
                    <div class="col-md-6">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <form action="<?php if($examiner == 'examiner'){echo 'submitted_examiners_claim.php';}else if($examiner == 'deo'){echo 'submitted_data_entry_claim.php';}else{echo 'submitted_system_admin_claim.php';} ?>" method="post" target="_blank">
                                    <input type="hidden" name="user_type" value="<?php if($examiner == 'examiner' || $examiner == 'sad'){echo 'ADMIN';}else{echo 'DEO';} ?>">
...
<script>
    $(document).ready(function () {
        ...
        var url = 'php/payment_schedule/<?php if($_GET['examiner'] == 'examiner'){echo 'examiners.php';}else if ($_GET['examiner'] == 'deo'){echo 'data_entry.php';}else{echo 'system_admins.php';} ?>';
        var entities = '<?php if($_GET['examiner'] == 'examiner'){echo 'examiners';}else if ($_GET['examiner'] == 'deo'){echo 'data_entry';}else{echo 'system_admin';} ?>';
