...
if($_SESSION['session_type'] == 'E'){
    ...
    $sql = $db_9->prepare('SELECT GROUP_CONCAT(DISTINCT sc.centre_code," - ",sc.centre_name SEPARATOR " ,") AS exam_centre,GROUP_CONCAT(DISTINCT su.subject_code," - ",su.subject_name SEPARATOR " ,") AS subject, GROUP_CONCAT(DISTINCT d.d_code," - ",d.d_name SEPARATOR" ,") AS district
