...
include '../../config.php';
$data_array = array();
$sql = $db_9->prepare('SELECT g.id AS id,g.belt_no AS belt_no,s.subject_code AS subject_code,s.subject_name AS subject_name,pa.paper_no AS paper,g.no_of_centres AS no_of_centres, g.no_of_scripts AS no_of_scripts
