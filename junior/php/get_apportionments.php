...
if(isset($_POST['subject_code']) && isset($_POST['paper']) && isset($_POST['belt_no']) && isset($_POST['group_id'])){
        ...
        $sql = $db_9->prepare('SELECT a.id AS id, s.subject_name AS subject_name, pa.paper_no AS paper, a.belt_no AS belt_no,a.school AS centre_no, a.script_no AS script_no,a.group_id AS group_id
