...
$sql = $db_9->prepare('SELECT ce.centre_code AS marking_centre_code, ce.name AS marking_centre_name,GROUP_CONCAT( DISTINCT su.subject_name SEPARATOR ", ") AS subject, GROUP_CONCAT( DISTINCT d.d_name SEPARATOR ", ") AS districts, mcc.apportion_id AS apportion_id, mcc.valid as valid,
