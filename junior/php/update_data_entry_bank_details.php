...
if(isset($_POST['bank'])){
        ...
        $sql = $db_9->prepare('UPDATE users SET nrc =:nrc,tpin =:tpin,phone =:phone, bank =:bank,branch =:branch,account_no =:account_no WHERE username =:username AND user_type = "DEO"');
        $sql->execute(array(
                ':bank'=>$bank,
                ':branch'=>$branch,
