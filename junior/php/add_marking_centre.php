...
if(marking_centre_exists($db_9,$centre_code) != 'false'){
$data_array['status'] = '400';
$data_array['response_msg'] = 'Centre code '.marking_centre_exists($db_9,$centre_code).' is already in us. use another code';
}else{
try{
        $sql = $db_9->prepare('INSERT IGNORE INTO centre(centre_code,name,centre_type,province)
