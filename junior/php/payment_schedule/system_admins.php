...
if(isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'ADMIN'){
        $sql = $db_9->prepare('SELECT marking_centre_code,marking_centre_name,nrc,tpin,full_name,position,no_of_scripts,subject_code,subject_name,paper_no,bank,branch,sortcode,account_no,net_rate,grossed_up_rate,gross_pay,15_wht,net_pay,belt_no,session_name
        FROM system_admin_claims WHERE username =:username AND marking_centre_code =:marking_centre_code');
        $sql->execute(array(
