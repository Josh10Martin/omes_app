                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-md-2 align-self-center p-0 m-0">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioDefault" id="text-check" checked>
                                      </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-md-2 p-0 m-0">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioDefault" id="select-check" >
                                      </div>
...
$(document).ready(function(){
 ...
 function get_apportionments(){
    ...
    $.ajax({
        ...
        method: 'POST',
        data: {subject_code:subject_code,paper:paper,belt_no:belt_no,group_id:id},
        dataType: 'json',
        success: function(data){
 ...
 function belt_no_not(){
    ...
    $.ajax({
        ...
        method: 'POST',
        data: {belt_no:belt_no,subject_code:subject_code,paper_no:paper_no},
        dataType: 'json',
        success:function(data){
