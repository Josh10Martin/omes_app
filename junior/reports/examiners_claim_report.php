...
$pdf = new Dompdf($options);
    ...
    FROM examiner_claim
    WHERE (nrc,tpin,subject_code,paper_no,belt_no,marking_centre_code) IN (SELECT nrc,tpin,subject_code,paper_no,belt_no,marking_centre FROM examiner WHERE marking_centre =:marking_centre_code) 
