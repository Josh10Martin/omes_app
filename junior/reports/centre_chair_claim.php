...
$pdf = new Dompdf($options);
    ...
    ex.account_no AS account_no, cc.centre_chairperson AS rate, cc.centre_chairperson AS amount_claimed,
                           ...
                           GROUP BY ex.title,ex.phone_number,ex.first_name,ex.last_name,cc.centre_chairperson,ex.nrc,ex.account_no,b.name,br.name');
    $sql->execute(array(
