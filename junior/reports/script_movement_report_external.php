...
$pdf = new Dompdf($options);
    ...
    $sql = $db_9->prepare('SELECT ce.centre_code AS marking_centre_code, ce.name AS marking_centre_name, GROUP_CONCAT( DISTINCT d.d_name SEPARATOR ", ") AS districts, mcc.apportion_id AS apportion_id,
            ...
            GROUP BY ce.centre_code, ce.name, mcc.apportion_id
    ');
...
$sql->bindColumn('apportion_id',$apportion_id);
            ...
            <tr >
                ...
                <td>
                   <p  style="text-align: center;">EXAMINATIONS COUNCIL OF ZAMBIA</p> 
                    ...
                    <p style="text-align: center;"><?php echo $province_name; ?> PROVINCE</p> 
                </td>
            </tr>
        </table>
