        ...
        <div class="account-page">
          ...
          <div class="row justify-content-center">
            ...
            <div class="dialog1"></div>
                        <form action="#" id="reset-password" autocomplete="off">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="password" required class="form-control" id="password1" name="password1" placeholder="Re-type new password">
    ...
    $('#reset-password').submit(function(e){
      ...
      $.ajax({
        ...
        success:function(data){
                ...
                $('.load').html('');
                if(data.status == '200'){
                        $('.dialog').text(data.response_msg+' You can login with new password').dialog('open');
                }else{
