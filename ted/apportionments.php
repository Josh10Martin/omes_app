                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-4 text-right m-b-20">
                            <a href="#" id="confirmApportionment" class="btn btn-white"><i class="fa fa-check" aria-hidden="true"></i> Submit Examiner Claims</a>
    ...
    <script>
		...
		$.ajax({
                        ...
                        if (data.status == '400') {
                            ...
                            $.each(data, function() {
                                $('table.table tbody').append('<tr class="' + this["id"] + '">' +
                                    '<td>' + this["belt_no"] + '</td>' +
                                    '<td>'+ this["group_code"] +' - ' + this["group_name"] + '</td>' +
                                    ...
                                    '<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>' +
                                    '<div class="dropdown-menu dropdown-menu-right">' +
                                    '<a class="dropdown-item table-icon" href="belts.php?belt_no=' + this["belt_no"] + '&group_code=' + this["group_code"] + '&group_name=' + encodeURIComponent(this["group_name"]) + '&id=' + this["id"] + '"><i class="fa fa-pencil m-r-5" style="color:blue"></i> View</a>' +
            ...
            function confirm_apportionments() {
                $('#confirmApportionment').click(function() {
                    // e.preventDefault();
            ...
            function submit_claim() {
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('.feedback').text('Submitting claims. Please wait..');
                    },
                    success: function(data) {
