        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>CODE:</label>
                            <input type="text" name="session_code" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" oninput="this.value = this.value.toUpperCase()" required>
                        </div>
                    </div>
