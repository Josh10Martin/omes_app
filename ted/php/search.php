...
if(isset($_POST['search'])){
        ...
        $sql = $db_ted->prepare('SELECT m.centre_code AS centre_code,m.exam_no AS exam_no,m.first_name AS first_name,m.last_name AS last_name,m.belt_no AS belt_no,
                                        ...
                                        m.subject_code AS subject_code,m.entered_by AS entered_by,m.date_entered AS date_entered, ce.name AS marking_centre
