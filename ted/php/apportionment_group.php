...
if(isset($_POST['belt_no'])){
        ...
        $id = $_SESSION['marking_centre_code'].'_'.$subject_code.'_'.$paper_no.'_'.$belt_no;
        // $belt = belt_added_ted($db_ted,$belt_no,$subject_code,$paper_no,$_SESSION['marking_centre_code']);
        ...
        // $centre_in_belt = centre_in_belt($db_ted,$school,$subject_code,$paper_no,$_SESSION['marking_centre_code'],$_SESSION['province_code']);
        ...
        if(!$belt_no){
                ...
                try{
                $sql = $db_ted->prepare('INSERT IGNORE INTO group_apportion(id,subject,paper,belt_no,marking_centre,username,date_created)
                                        VALUES(:id,:subject_code,:paper_no,:belt_no,:marking_centre_code,:username,NOW())');
                $sql->execute(array(
