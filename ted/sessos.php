...
<div class="page-wrapper">
    <div class="content">
        <div class="row justify-content-between px-2">
            <div class="col-xs-6">
                <h4 class="page-title">SESO USERS</h4>
            </div>
            <div class="col-xs-6">
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.status == '400'){
                ...
                $('input[type=email][name=email]').attr('readonly',true).val(' ');
    ...
    $('#add_seso_form').submit(function(e){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('input[type=text][name=first_name]').val(first_name);
                $('input[type=text][name=last_name]').val(last_name);
                $('input[type=hidden][name=user_name]').val(username);
        ...
        function send_seso_email(email,username,password,first_name,last_name){
            $.ajax({
                ...
                url: 'https://verify.exams-council.org.zm/orvs/send_ted_seso_email.php',
                method: 'POST',
