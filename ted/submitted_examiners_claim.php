...
<div class="page-wrapper">
    <div class="content">
        <div class="row justify-content-between px-2">
            <div class="col-sm-6">
                <h4 class="page-title">SUBMITTED CLAIMS (TEACHER EDUCATION EXAMINERS)</h4>
            </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <select name="course_group" class="form-control" id="course_group" required>
            ...
            <div class="col-md-6">
              ...
              <select name="app_belt_no2" class="form-control" id="belt" required>
                <option value="" disabled selected>Select Belt No.</option>
                <!-- Dynamic options loaded via script -->
              </select>
            </div>
            <div class="col-md-6">
              <label for="belt">Session</label>
...
<script>
    $(document).ready(function(){
        ...
        dataType: 'json',
        success:function(data){
          $('select[name=marking_centre]').empty();
      ...
      var course_group = $(this).val();
       marking_centre_code = $('select[name=marking_centre]').val();
		$.ajax({
			...
			method: 'POST',
			data: {course_group:course_group,marking_centre_code:marking_centre_code},
			dataType: 'json',
			success:function(data){
    ...
    function get_year(){
        $('select[name=app_belt_no2]').change(function(){
...
function showselect2(){
  $('#examiners_claim_modal').on('shown.bs.modal', function () {
      $('#marking_centre,#course_group,#belt,#session').select2({
