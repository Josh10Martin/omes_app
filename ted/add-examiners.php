        ...
        <div class="row">
            <div class="col-md-6 ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p>Email:<input type="email" placeholder="email..." class="form-control" name="email"oninput="this.value = this.value.toLowerCase()"></p>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-md-6">
                <div class="title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p>ACCOUNT NUMBER:<input required type="text" maxlength="15"  placeholder=" account number" class="form-control" name="account_number"></p>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <p>BELT NUMBER:
                      <select name="belt_number" class="select" id="" reqired>
                        <option value="">Belt Number</option>
