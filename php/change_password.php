...
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['password1']) && isset($_POST['password2'])){
                ...
                if(password_verify($password,$db_password)){
                        if($pattern){
                                if($password1 == $password2){
                                        ...
                                        $sql2 = $db_9->prepare('UPDATE users SET password = :new_password, first_login = "false" WHERE username =:username');
